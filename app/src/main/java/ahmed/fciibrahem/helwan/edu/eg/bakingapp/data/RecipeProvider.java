...
import static ahmed.fciibrahem.helwan.edu.eg.bakingapp.data.RecipeContract.CONTENT_AUTHORITY;
import static ahmed.fciibrahem.helwan.edu.eg.bakingapp.data.RecipeContract.PATH_RECIPE;
...
//if any Update happen to the Database use this string to identify the broadcast
    public static final String ACTION_DATA_UPDATED = "ahmed.fciibrahem.helwan.edu.eg.bakingapp.data.ACTION_DATA_UPDATED";
